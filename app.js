...
function generateNXCode(pocketCount, finalMass) {
  ...
  const pyCode = [
    ...
    'WALL_MARGIN      = 2.5',
    'CENTRAL_EXCLUDE_R = (CENTRAL_HOLE_DIA / 2.0) + 2.5',
    '',
  ...
  if (state.pattern === "isogrid") {
    pyCode.push(
      ...
      '            ]:',
      '                d = math.hypot(cx, cy)',
      '                # Keep pocket vertices inside outer structural rim and outside central hole rim',
      '                if (d + r_in > RADIUS - 4.0) or (d - r_in < (CENTRAL_HOLE_DIA * 0.5 + 4.0)):',
      '                    continue',
